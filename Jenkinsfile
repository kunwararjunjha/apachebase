    ...
    stages {
        stage('Build Docker Image') {
         ...
         stage('Tag image') {
             ...
             steps {
                  sh ''' ansible-playbook -i /var/lib/jenkins/workspace/Ansible_httpd/inventory.ini /var/lib/jenkins/workspace/Ansible_httpd/apache.yml --extra-vars "ansible_become_password=a"     '''
